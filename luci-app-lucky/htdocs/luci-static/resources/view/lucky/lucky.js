...
return view.extend({
    ...
    render: function(data) {
        ...
        var container = E('div', { class: 'lucky-map' }, [
            E('h2', { class: 'cbi-map-title' }, _('Lucky')),
            E('div', { class: 'cbi-map-descr' }, _('IPv4/IPv6 port forwarding, DDNS, HTTP/HTTPS reverse proxy, WOL and more.'))
        ]);
